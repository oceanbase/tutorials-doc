# Use other tools for data migration and synchronization
...
![Flink CDC](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_04_migration_and_synchronization_oceanbase/07_migration_and_synchronization_through_other_tools/001.png)
...
![How Canal works](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_04_migration_and_synchronization_oceanbase/07_migration_and_synchronization_through_other_tools/002.png)
...
![Canal architecture ](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_04_migration_and_synchronization_oceanbase/07_migration_and_synchronization_through_other_tools/003.png)
...
![DataX topology](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_04_migration_and_synchronization_oceanbase/07_migration_and_synchronization_through_other_tools/004.png)
...
![DataX architecture](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_04_migration_and_synchronization_oceanbase/07_migration_and_synchronization_through_other_tools/005.png)
...
![DataX modules](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_04_migration_and_synchronization_oceanbase/07_migration_and_synchronization_through_other_tools/006.png)
...
This section describes how to deploy and use SeaTunnel. For more information about SeaTunnel, see [Ecosystem components for data migration and synchronization](20.ecological-tools-of-migration-synchronization.md).
