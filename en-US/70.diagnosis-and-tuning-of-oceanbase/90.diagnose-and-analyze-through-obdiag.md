# Use obdiag for diagnostics and analytics
...
![obdiag](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_07_diagnosis_and_tuning/09_diagnose_and_analyze_through_obdiag/001.png)
...
![Benefits](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_07_diagnosis_and_tuning/09_diagnose_and_analyze_through_obdiag/002.png)
...
![Features](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_07_diagnosis_and_tuning/09_diagnose_and_analyze_through_obdiag/003.png)
...
The method for adding an information collection scenario is similar to that of adding an inspection scenario. Here is an example:
...
Root cause analysis scenarios are recorded in Python files under the `~/.obdiag/rca` directory. To add a root cause analysis scenario, you must configure specific link logic for root cause analysis in the Python code.
...
![Overall process](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_07_diagnosis_and_tuning/09_diagnose_and_analyze_through_obdiag/004.png)