# Use JMeter to test OceanBase Database in simulated business scenarios
...
![Create a test plan](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/001.png)
...
![Create a thread group](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/002.png)
...
![Add a JDBC connection](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/003.png)
...
* Configure transaction variables
   ...
   ![Configure transaction variables](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/004.png)
...
* Start a transaction
   ...
   ![Start a transaction](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/005.png)
...
* Create a JDBC request to deduct the transferred amount from the balance of account A
   ...
   ![Deduct the transferred amount from the balance of account A](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/006.png)
...
* Add Post logic to obtain the return value of the JDBC request that deducts the transferred amount from the balance of account A
   ...
   ![Processing logic for account A](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/007.png)
...
* Create a JDBC request to increase the balance of account B
   ...
   ![Increase the balance of account B](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/008.png)
...
* Add Post logic to obtain the return value of the JDBC request that increases the balance of account B
   ...
   ![Processing logic for account B](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/009.png)
...
* Add an IF controller
   ...
   ![Add an IF controller](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/010.png)
...
* Add a commit action upon update success
   ...
   ![Commit a transaction](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/011.png)
...
* Add an IF controller
   ...
   ![Add an IF controller](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/012.png)
...
* Add a commit action upon update failure
   ...
   ![Roll back a transaction](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/013.png)

### View the results

Click **Thread-Group** and choose **Add** > **Listener** > **View Results Tree** to create a result tree file to view the test results.

![View the results](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/014.png)

Click **Thread Group** and choose **Add** > **Listener** > **Aggregate Report** to create an aggregated report that aggregates the results.

![View the report](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_03_test_oceanbase_database/06_jmeter_test/015.png)