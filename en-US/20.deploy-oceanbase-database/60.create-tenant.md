...
1. Configure tenant information as shown in the following figure.
   ...
   ![Configure the tenant](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/06_create-tenant/001.png)

2. Configure the IP address allowlist and variables of the tenant.

   ![Configure the tenant](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/06_create-tenant/002.png)

3. View the tenant creation task.

   To learn about the task execution process, you can download the logs.

   ![View logs](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/06_create-tenant/003.png)
