# Deploy OceanBase Database in an experience environment
...
For the requirements for deployment in a production environment, see [Preparations before deployment](10.preparation-before-deployment.md).
...
2. Click **Try Now** to start the deployment process.
   ...
   ![Start](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/001.png)
...
3. Select **OceanBase and supporting tools** and click **OK**.
   ...
   ![Select](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/002.png)
...
4. On the **Deployment Configuration** page, modify **Cluster Name** and select the components that you want to deploy. You can also retain the default configurations. By default, all components are deployed.
   ...
   ![Deployment configuration](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/003.png)
...
5. On the **Node Configuration** page, enter node IP addresses and the user password and then click **Next Step** to go to the **Cluster Configuration** page.
   ...
   ![Node configuration](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/004.png)
...
6. On the **Cluster Configuration** page, specify the deployment mode, password, directory, port, and other information about the cluster. You can also retain the default values.
   ...
   ![Cluster configuration](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/005.png)
...
7. On the **Pre-check** page, verify the configuration information and then click **Pre-check**.
   ...
   ![Precheck](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/006.png)

   ![Precheck](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/007.png)
...
8. After the precheck is passed, click **Deploy** to start the deployment.
   ...
   ![Deployment](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/008.png)

9. Click **Finish**.
   ![Finish](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/03_deploy_personal_environment/009.png)
