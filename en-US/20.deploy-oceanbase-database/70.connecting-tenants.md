...
1. Create a connection.
   ...
   ![Create a connection](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/07_connecting-tenants/001.png)

2. Save and open the connection.

   ![Open the connection](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/en-US/chapter_02_deploy_oceanbase_database/07_connecting-tenants/002.png)
