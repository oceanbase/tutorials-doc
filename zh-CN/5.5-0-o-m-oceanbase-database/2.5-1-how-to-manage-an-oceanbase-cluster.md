...
OceanBase 数据库相关的内存分配可以先看下面的内存分配图。![5-1s](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7296469361/p369805.jpeg)
...
3. 启动进程
   ...
   进程启动后等 5\~10 秒钟后再查看，对进程是否启动成功进行确认。
...
1. 环境初始化
   ...
   初始化新机器环境的具体操作步骤，请参见 [2.4 如何初始化服务器环境](/zh-CN/2.chapter-2-how-to-deploy-oceanbase-community-edition/5.2-4-how-to-initialize-the-server-environment.md)。
   

2. 启动进程

   observer 进程第一次启动时需要指定一些参数，具体操作步骤请参见 [2.11 （高级）如何手动部署 OceanBase 集群](/zh-CN/2.chapter-2-how-to-deploy-oceanbase-community-edition/12.2-11-advanced-how-to-manually-deploy-an-oceanbase-cluster.md)。
...
1. 机器节点进程初始化
   ...
   具体步骤请参见：[2.4 如何初始化服务器环境](/zh-CN/2.chapter-2-how-to-deploy-oceanbase-community-edition/5.2-4-how-to-initialize-the-server-environment.md) 和 [2.11 （高级）如何手动部署 OceanBase 集群](/zh-CN/2.chapter-2-how-to-deploy-oceanbase-community-edition/12.2-11-advanced-how-to-manually-deploy-an-oceanbase-cluster.md)。
