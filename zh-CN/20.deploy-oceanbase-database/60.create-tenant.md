...
> **说明**
>
> 本节仅简单介绍如何使用 OCP 创建租户，详细的操作步骤可参见官网《OceanBase 云平台》文档 [快速入门/新建租户](https://www.oceanbase.com/docs/common-ocp-1000000000826433)。
...
若待新建租户的集群可使用 obd 管理，可直接使用 obd 命令来创建租户。若待新建租户的集群非 obd 管理的集群，且集群所用 OceanBase 数据库为社区版 V4.2.1 BP4 或之后版本，且已启动过 obshell，您可先执行接管命令后再使用如下 obd 命令创建租户，接管操作可参见官网《OceanBase 安装部署工具》文档 [使用指南/命令行/使用 obd 接管集群](https://www.oceanbase.com/docs/community-obd-cn-1000000000774269)。
...
> **说明**
>
> 本节仅简单介绍如何使用 ob-operator 创建租户，详细的操作步骤可参见 [创建租户](https://oceanbase.github.io/ob-operator/zh-Hans/docs/manual/ob-operator-user-guide/tenant-management-of-ob-operator/create-tenant)。
...
1. 创建配置文件
   ...
   配置文件内容可参见 GitHub 中 [tenant.yaml](https://github.com/oceanbase/ob-operator/blob/2.2.2_release/example/tenant/tenant.yaml) 示例，各个字段的详细介绍可参见 [创建租户示例](https://oceanbase.github.io/ob-operator/zh-Hans/docs/manual/ob-operator-user-guide/tenant-management-of-ob-operator/create-tenant#%E5%88%9B%E5%BB%BA%E7%A7%9F%E6%88%B7%E7%A4%BA%E4%BE%8B)。
