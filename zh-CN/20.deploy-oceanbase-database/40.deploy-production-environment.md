...
| OceanBase 数据库  | <ul><li>建议使用 ob-operator 推荐的 OceeanBase 数据库版本。</li><li>推荐部署 3 节点集群，且按物理机推荐资源要求设置。</li></ul> | <ul><li>ob-operator 2.1.2 对应的 OceanBase 数据库镜像版本为 4.2.1.3。</li><li>当 OceanBase 数据库所需资源为 16C32G 时，容器最低资源配置为 16C36GB（内存默认按 90% 分配给 OcaeanBase 数据库）。</li></ul> |
