...
| OceanBase 数据库  | <ul><li>建议不低于 V4.0.0，推荐使用 LTS 版本（如 V4.2.1）。</li><li>推荐部署 3 节点集群，且按物理机推荐资源要求设置。</li></ul> | 当 OceanBase 数据库所需资源为 16C32G 时，容器最低资源配置为 16C36GB（内存默认按 90% 分配给 OcaeanBase 数据库）。 |
