...
```bash
[root@obce00 ~]# mysql -h 172.xx.xxx.52 -P 2883 -u proxyro@sys#obdemo -puY7Yf8zx -c -A
...
```sql
mysql -h 172.xx.xxx.52 -u root@proxysys -P 2883 -p0MdTv1tm
...
```bash
[root@obce00 ~]# mysql -h 172.xx.xxx.52 -P 2883 -u proxyro@sys#obdemo -puY7Yf8zx -c -A -Ns -e "show databases;"
oceanbase
information_schema
[root@obce00 ~]#
```
...
```bash
[root@obce00 ob-loader-dumper-2.1.13-SNAPSHOT]# bin/obdumper -h 172.xx.xxx.52 -P 2883 -u dumper -p 123456 --sys-user=proxyro --sys-password=uY7Yf8zx -c obdemo -t obmysql -D test --ddl --all -f /tmp/obdumper
...
```bash
[root@obce00 ob-loader-dumper-2.1.13-SNAPSHOT]# bin/obdumper -h 172.xx.xxx.52 -P 2883 -u dumper -p ****** --sys-user=proxyro --sys-password=uY7Yf8zx -c obdemo -t obmysql -D test --csv --all -f /tmp/obdumper
...
```bash
[root@obce00 ob-loader-dumper-2.1.13-SNAPSHOT]# bin/obloader -h 172.xx.xxx.52 -P 2883 -u loader -p ****** --sys-user=proxyro --sys-password=uY7Yf8zx -c obdemo -t obmysql -D test2 --ddl --all -f /tmp/obdumper
...
```bash
[root@obce00 ob-loader-dumper-2.1.13-SNAPSHOT]# bin/obloader -h 172.xx.xxx.52 -P 2883 -u loader -p ****** --sys-user=proxyro --sys-password=uY7Yf8zx -c obdemo -t obmysql -D test2 --csv --all -f /tmp/obdumper
