...
![image.png](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-01.png)
...
![](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-02.png)
...
![](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-03.png)

另一个缺点就是由于本地索引是创建在数据分片内部，因此无法保证索引键值的全局唯一性。例如下图的例子中，本地索引的两部分都可能出现 'Edward' 这个重复键值，因此数据库要求要创建带唯一性约束的本地索引必须指定数据分片的分区键。

![](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-04.png)
...
![](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-05.png)
...
![image.png](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-06.png)
...
![image.png](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-07.png)
...
![image.png](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/tutorials/V4.x/60.business-development-through-oceanbase/40.extended-functionality-08.png)
