...
OBAgent 部署配置文件可以跟 OceanBase 集群部署配置文件部署在一起，也可以后期单独部署。本节附录 [A.1](./10.2-9-how-to-deploy-obagent.md/#a1-oceanbase-%E5%92%8C-obagent-%E4%B8%80%E8%B5%B7%E7%9A%84%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6) 示例了同时部署 OceanBase 集群和 OBAgent。
...
2.监控用户（`monitor_user` 对应）和密码需要在 sys 租户下创建：`grant select on oceanbase.* to monitor identified by 'fLyaqjrp2R';`。
