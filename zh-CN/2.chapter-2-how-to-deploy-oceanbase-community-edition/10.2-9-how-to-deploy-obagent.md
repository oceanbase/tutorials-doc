...
<main id="notice" type='notice'>
  ...
  <ol>
  <li>
  <p>指定节点的连接端口用的是 <code>sql_port</code> 不是 <code>mysql_port</code>，跟 OBServer 节点配置不一样。</p>
  </li>
  <li>
  <p>监控用户（<code>monitor_user</code> 对应）和密码需要在 sys 租户下创建：<code>grant select on oceanbase.* to monitor identified by 'fLy***rp2R';</code>。</p>
  </li>
  </ol>
</main>
