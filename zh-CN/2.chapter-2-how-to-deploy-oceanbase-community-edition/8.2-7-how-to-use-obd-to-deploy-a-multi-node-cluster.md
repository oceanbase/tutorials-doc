...
| 机器类型 |                         云主机 ECS                         |
|------|---------------------------------------------------------|
| IP   | 192.168.0.2 192.168.0.4 192.168.0.1 192.168.0.3 |
| 网卡名  | eth0                                                    |
...
| OBProxy  | 192.168.0.4 | OceanBase 访问反向代理    |
| OBProxy  | 192.168.0.1 | OceanBase 访问反向代理    |
| OBProxy  | 192.168.0.3 | OceanBase 访问反向代理    |
...
obproxy:
  ...
  global:
    ...
    rs_list: 192.168.0.4:2881;192.168.0.1:2881;192.168.0.3:2881
...
| obproxy      | rs_list                 | 192.168.0.4:2881;192.168.0.1:2881;192.168.0.3:2881 | OceanBase 集群 rootservice 服务地址，由 sys 租户的三副本所在节点 IP 组成。 可以手动指定，也可以不指定，依赖前面的 `depends` 配置节自动从 OceanBase 集群配置里获取。 |
...
[WARN] (192.168.0.4) The recommended value of fs.aio-max-nr is 1048576 (Current value: 65536)
[WARN] (192.168.0.4) The recommended number of open files is 655350 (Current value: 65535)
[WARN] (192.168.0.1) The recommended value of fs.aio-max-nr is 1048576 (Current value: 65536)
[WARN] (192.168.0.1) The recommended number of open files is 655350 (Current value: 65535)
[WARN] (192.168.0.3) The recommended value of fs.aio-max-nr is 1048576 (Current value: 65536)
[WARN] (192.168.0.3) The recommended number of open files is 655350 (Current value: 65535)
...
+---------------+---------+------+-------+--------+
| 192.168.0.1 | 3.1.0   | 2881 | zone2 | active |
| 192.168.0.3 | 3.1.0   | 2881 | zone3 | active |
| 192.168.0.4 | 3.1.0   | 2881 | zone1 | active |
+---------------+---------+------+-------+--------+
...
+---------------+------+-----------------+--------+
| 192.168.0.4 | 2883 | 2884            | active |
| 192.168.0.1 | 2883 | 2884            | active |
| 192.168.0.3 | 2883 | 2884            | active |
+---------------+------+-----------------+--------+
obce-3zones running
```
...
* 检查 OceanBase 集群各个节点进程信息
  ...
  ```bash
  IPS="192.168.0.4 192.168.0.1 192.168.0.3"
  ...
  192.168.0.4
  admin       6987       1 69 08:35 ?        01:38:26 /home/admin/oceanbase-ce/bin/observer -r 192.168.0.4:2882:2881;192.168.0.1:2882:2881;192.168.0.3:2882:2881 -o __min_full_resource_pool_memory=268435456,memory_limit=8G,system_memory=3G,stack_size=512K,cpu_count=16,cache_wash_threshold=1G,workers_per_cpu_quota=10,schema_history_expire_time=1d,net_thread_count=4,major_freeze_duty_time=Disable,minor_freeze_times=10,enable_separate_sys_clog=0,enable_merge_by_turn=False,datafile_size=50G,enable_syslog_wf=False,enable_syslog_recycle=True,max_syslog_file_count=10,root_password=0EI5N08d,redo_dir=/redo -z zone1 -p 2881 -P 2882 -n obce-3zones -c 2 -d /data -i eth0 -l WARN
  192.168.0.1
  admin       7064       1 87 08:35 ?        02:02:59 /home/admin/oceanbase-ce/bin/observer -r 192.168.0.4:2882:2881;192.168.0.1:2882:2881;192.168.0.3:2882:2881 -o __min_full_resource_pool_memory=268435456,memory_limit=8G,system_memory=3G,stack_size=512K,cpu_count=16,cache_wash_threshold=1G,workers_per_cpu_quota=10,schema_history_expire_time=1d,net_thread_count=4,major_freeze_duty_time=Disable,minor_freeze_times=10,enable_separate_sys_clog=0,enable_merge_by_turn=False,datafile_size=50G,enable_syslog_wf=False,enable_syslog_recycle=True,max_syslog_file_count=10,root_password=0EI5N08d,redo_dir=/redo -z zone2 -p 2881 -P 2882 -n obce-3zones -c 2 -d /data -i eth0 -l WARN
  192.168.0.3
  admin       6920       1 72 08:35 ?        01:42:42 /home/admin/oceanbase-ce/bin/observer -r 192.168.0.4:2882:2881;192.168.0.1:2882:2881;192.168.0.3:2882:2881 -o __min_full_resource_pool_memory=268435456,memory_limit=8G,system_memory=3G,stack_size=512K,cpu_count=16,cache_wash_threshold=1G,workers_per_cpu_quota=10,schema_history_expire_time=1d,net_thread_count=4,major_freeze_duty_time=Disable,minor_freeze_times=10,enable_separate_sys_clog=0,enable_merge_by_turn=False,datafile_size=50G,enable_syslog_wf=False,enable_syslog_recycle=True,max_syslog_file_count=10,root_password=0EI5N08d,redo_dir=/redo -z zone3 -p 2881 -P 2882 -n obce-3zones -c 2 -d /data -i eth0 -l WARN
  ```
...
```bash
mysql -h 192.168.0.4 -uroot@sys#obce-3zones -P2883 -p0EI5N08d -c -A oceanbase

输出：
[admin@obce00 ~]$ mysql -h 192.168.0.4 -uroot@sys#obce-3zones -P2883 -p0EI5N08d -c -A oceanbase
...
+-------+--------------------+-----------+----------+--------------+-------------+----------------------------+----------------------------+--------+----------------------------+------------------------------------------------------------------------+
| zone1 | 192.168.0.4:2882 |        14 |     11.5 |            5 |           4 | 1970-01-01 08:00:00.000000 | 2021-09-12 08:36:06.357140 | active | 1970-01-01 08:00:00.000000 | 3.1.0_3-b20901e8c84d3ea774beeaca963c67d7802e4b4e(Aug 10 2021 08:10:38) |
| zone2 | 192.168.0.1:2882 |        14 |     11.5 |            5 |           4 | 1970-01-01 08:00:00.000000 | 2021-09-12 08:36:07.605244 | active | 1970-01-01 08:00:00.000000 | 3.1.0_3-b20901e8c84d3ea774beeaca963c67d7802e4b4e(Aug 10 2021 08:10:38) |
| zone3 | 192.168.0.3:2882 |        14 |     11.5 |            5 |           4 | 1970-01-01 08:00:00.000000 | 2021-09-12 08:36:07.631981 | active | 1970-01-01 08:00:00.000000 | 3.1.0_3-b20901e8c84d3ea774beeaca963c67d7802e4b4e(Aug 10 2021 08:10:38) |
+-------+--------------------+-----------+----------+--------------+-------------+----------------------------+----------------------------+--------+----------------------------+------------------------------------------------------------------------+
...
obclient -h 192.168.0.4 -uroot@sys#obce-3zones -P2883 -p0EI5N08d -c -A oceanbase
```
