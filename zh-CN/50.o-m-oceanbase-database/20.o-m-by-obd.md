...
这里主要介绍如何升级 OBD 部署的集群环境下各个组件，包括 OceanBase 数据库、OBProxy、OCP EXpress 等组件，不包含 OBD 部署的 OCP 升级介绍，如果需要升级 OCP，请参看[图形化界面升级 OCP](https://www.oceanbase.com/docs/common-ocp-1000000000584958)。OBD 不支持同时升级多个组件，因此将按以下升级顺序进行介绍。
<!-- 更新描述 -->
...
## 使用 OBD 扩容管理的服务
<!-- 需要确认下是否是任意组件，V2.9.0 中有提到 oblogproxy 不支持 -->
