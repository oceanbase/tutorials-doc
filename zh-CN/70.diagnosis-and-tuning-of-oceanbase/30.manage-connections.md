...
![](https://intranetproxy.alipay.com/skylark/lark/0/2024/png/132317/1707126718269-e65c1073-fd0d-4038-a249-1f1ab551ec4a.png#clientId=u131db584-2056-4&from=paste&id=uaec56859&originHeight=104&originWidth=457&originalType=url&ratio=1.7999999523162842&rotation=0&showTitle=false&status=done&style=none&taskId=u98d8cd9e-7060-4ed5-ac64-85a4f6464b2&title=)
...
![](https://intranetproxy.alipay.com/skylark/lark/0/2024/png/132317/1707126718265-02c96216-ed40-4a1a-baa8-097789c3a82d.png#clientId=u131db584-2056-4&from=paste&id=u2eb0115a&originHeight=226&originWidth=712&originalType=url&ratio=1.7999999523162842&rotation=0&showTitle=false&status=done&style=none&taskId=u0b3fdc22-de2f-414f-8a29-61936efaca1&title=)
...
详细的操作和输出介绍可参见《OceanBase 数据库》文档[查看租户会话](https://www.oceanbase.com/docs/common-oceanbase-database-cn-1000000000507733)，此处仅简单介绍一种查看方法。

1. 使用 root 用户登录 OceanBase 数据库的 sys 租户查看集群内的所有 OBServer。
...
2. 选择想要查看的 OBServer 节点，直连该 OBServer 节点，以直连 10.10.10.1，SQL 端口为 2881 为例。执行 show processlist; 命令查看当前 OBServer 节点的所有连接。
